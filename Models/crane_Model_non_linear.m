...
persistent params
if isempty(params)
defaultParams = struct('Tx', 39.108, 'Fddf1', 2.7741, 'Y_Gain', 9.5952, 'Fsdf2', 0.0018091, ...
                       'Ty', 19.549, 'Fddf2', 1.0234, 'X_Gain', 59.065, 'Fsdf1', 0.0016816, ...
                       'Tz', 539.37, 'Fddf3', 8.3732, 'L_Gain', 41.809, 'Fsdf3', 13.176, ...
                       'Fv4', 0.013824, 'Fv5', 0.0071167, 'l0', 0.18606, 'mc', 0.468, 'mY', 1.155, 'mX', 3.3550, 'g', 9.81);
if ~isempty(varargin)
...
Z_Gain = params.L_Gain;
static_friction_force_z = params.Fsdf3;
static_friction_force_y = params.Fsdf2;
static_friction_force_x = params.Fsdf1;

% Input normalization
un = [(u(1)/mT)*X_Gain, (u(2)/(mY))*Y_Gain, (u(3)/L)*Z_Gain];
un1 = un(1);
un2 = un(2);
un3 = un(3);
t2 = x(6); % xdot
...
t51 = 1.0 / t50;
et1 = t8 * t17 * t23 + t4 * t7 * un3 - Tz * t4 * t5 * t7 - Tz_d * t4 * t7 * t41 + L * mT * t4 * un3 + L * mY * t4 * un3 + mT * mY * t4 * un3 + mT * t7 * t17 * t23 + mY * t7 * t17 * t23 + mT * t4 * t44 * un3 - t8 * t17 * t23 * t24 + t8 * t17 * t22 * t31 - t8 * t17 * t23 * t31 - t8 * t17 * t22 * t33 - t8 * t17 * t23 * t34 - t4 * t7 * t19 * un2 - t4 * t7 * t24 * un3 - t4 * t7 * t31 * un3 - Fax * t7 * t9 * t10 * t11 - Fay * t7 * t13 * t18 * t19 + Tz * mT * t4 * t5 * t14 + Tz * mT * t4 * t5 * t42 + Tz_d * mT * t4 * t14 * t41 + Tz_d * mT * t4 * t41 * t42 + Tz * mY * t4 * t5 * t14 + Tz * mY * t4 * t5 * t16 + Tz * mY * t4 * t5 * t37 + Tz * mY * t4 * t5 * t47 + Tz_d * mY * t4 * t14 * t41 + Tz_d * mY * t4 * t16 * t41 + Tz_d * mY * t4 * t37 * t41 + Tz_d * mY * t4 * t41 * t47 + Ty * t3 * t4 * t7 * t19;
et2 = Ty_d * t4 * t7 * t19 * t40 + Tz * t4 * t5 * t7 * t24 + Tz * t4 * t5 * t7 * t31 + Tz_d * t4 * t7 * t24 * t41 + Tz_d * t4 * t7 * t31 * t41 + L * mT * mY * t17 * t23 + mT * mY * t17 * t22 * t42 + g * t4 * t8 * t9 * t18 - g * t4 * t8 * t9 * t32 - g * t4 * t8 * t18 * t25 + g * t4 * t8 * t25 * t32 + mT * t7 * t17 * t22 * t31 - mY * t7 * t17 * t23 * t24 + mY * t7 * t17 * t22 * t31 + mT * t4 * t14 * t19 * un2 + mY * t4 * t14 * t24 * un3 + mY * t4 * t26 * t45 * un3 + t7 * t16 * t17 * t23 * t31 + t7 * t16 * t17 * t22 * t33 + t7 * t16 * t17 * t23 * t34 - t8 * t17 * t22 * t24 * t31 + t8 * t17 * t23 * t24 * t31 + t8 * t17 * t22 * t24 * t33 - t8 * t17 * t22 * t26 * t31 - t8 * t17 * t23 * t26 * t31 + t8 * t17 * t22 * t26 * t33 + t8 * t17 * t23 * t24 * t34 + t8 * t17 * t23 * t26 * t33 - t8 * t17 * t23 * t26 * t34 + t8 * t17 * t23 * t26 * t36;
...
et4 = Fay * mT * t13 * t14 * t18 * t19 + Fax * mY * t9 * t10 * t11 * t14 + Fax * t7 * t9 * t10 * t11 * t31 + Fax * t7 * t9 * t10 * t11 * t34 + Fay * t7 * t13 * t18 * t19 * t24 + Fay * t7 * t13 * t18 * t19 * t26 + Ty * L * mT * t3 * t4 * t19 + Ty_d * L * mT * t4 * t19 * t40 + Tx * t2 * t4 * t7 * t10 * t18 - Tx * t2 * t4 * t7 * t10 * t32 + Tx_d * t4 * t7 * t10 * t18 * t39 - Tx_d * t4 * t7 * t10 * t32 * t39 - Ty * t3 * t4 * t7 * t19 * t24 - Ty * t3 * t4 * t7 * t26 * t35 - Ty_d * t4 * t7 * t19 * t24 * t40 - Ty_d * t4 * t7 * t26 * t35 * t40 - Tz * t4 * t5 * t7 * t24 * t31 + Tz * t4 * t5 * t7 * t26 * t34 - Tz_d * t4 * t7 * t24 * t31 * t41 + Tz_d * t4 * t7 * t26 * t34 * t41 + Fay * L * mY * t13 * t18 * t19 * t26 + Tx * L * mY * t2 * t4 * t10 * t18 + Tx_d * L * mY * t4 * t10 * t18 * t39 + g * L * mT * mY * t4 * t9 * t18 - Tx * t2 * t4 * t7 * t10 * t18 * t34;
...
et10 = t4 * t7 * t26 * t31 * t34 * un2 - t4 * t5 * t8 * t13 * t26 * 1.0 / t38.^5 * 2.0 + Fay * L * mY * t13 * t26 * t32 + Fax * t7 * t9 * t10 * t11 * t19 - Fax * t7 * t9 * t10 * t11 * t35 - Fay * t7 * t13 * t18 * t24 * t34 + Tz * mT * t4 * t5 * t19 * t44 + Tz_d * mT * t4 * t19 * t41 * t44 + Tz * mY * t4 * t5 * t19 * t46 + Tz_d * mY * t4 * t19 * t41 * t46 - Ty * t3 * t4 * t7 * t24 * t31 - Ty * t3 * t4 * t7 * t26 * t33 - Ty_d * t4 * t7 * t24 * t31 * t40 - Ty_d * t4 * t7 * t26 * t33 * t40 - Tz * t4 * t5 * t7 * t19 * t31 - Tz_d * t4 * t7 * t19 * t31 * t41 + Fax * L * mY * t9 * t10 * t11 * t19 - Fax * t7 * t9 * t10 * t11 * t19 * t31 - Tx * t2 * t4 * t7 * t10 * t18 * t19 + Tx * t2 * t4 * t7 * t10 * t19 * t32 + Tx * t2 * t4 * t7 * t10 * t18 * t35 - Tx_d * t4 * t7 * t10 * t18 * t19 * t39 + Tx_d * t4 * t7 * t10 * t19 * t32 * t39;
et11 = Tx_d * t4 * t7 * t10 * t18 * t35 * t39 - Ty * t3 * t4 * t7 * t26 * t31 * t34 - Ty_d * t4 * t7 * t26 * t31 * t34 * t40 + Tz * t4 * t5 * t7 * t19 * t24 * t31 + Tz * t4 * t5 * t7 * t19 * t26 * t31 + Tz_d * t4 * t7 * t19 * t24 * t31 * t41 + Tz_d * t4 * t7 * t19 * t26 * t31 * t41 - L * mT * mY * t4 * t5 * t13 * t18 * 2.0 + g * mT * t4 * t7 * t9 * t19 * t32 + g * mT * t4 * t7 * t9 * t18 * t35 - g * mY * t4 * t7 * t9 * t18 * t19 + g * mY * t4 * t7 * t18 * t19 * t25 + g * t4 * t7 * t9 * t16 * t18 * t19 + g * t4 * t8 * t9 * t18 * t19 * t26 - g * t4 * t8 * t9 * t19 * t26 * t32 - g * t4 * t8 * t9 * t18 * t26 * t35 + L * mY * t4 * t10 * t18 * t19 * un1 + mT * t4 * t5 * t7 * t13 * t18 * t34 * 2.0 + mY * t4 * t5 * t7 * t13 * t18 * t24 * 2.0 + mY * t4 * t5 * t7 * t13 * t26 * t32 * 2.0 + mY * t7 * t17 * t19 * t22 * t24 * t31 + mY * t7 * t17 * t19 * t22 * t26 * t31;
...
derivatives = [t2; t3; t5; t11; t13; t20 * t38 * t51 * (-Fax * t9 * t11 - t4 * t18 * un1 + Tx * t2 * t4 * t18 + Tx_d * t4 * t18 * t39 + t10 * t17 * t22 * t44 + t4 * t10 * t31 * un3 + Fay * t10 * t13 * t18 * t19 - Tz * t4 * t5 * t10 * t31 - Tz_d * t4 * t10 * t31 * t41 + L * t10 * t17 * t22 * t33 + t10 * t17 * t22 * t34 * t42 + g * L * t4 * t9 * t10 * t32 + g * t4 * t9 * t10 * t14 * t18 + g * t4 * t9 * t10 * t18 * t43); t20 * t49 * (t4 * un2 + Fay * t13 * t18 - Ty * t3 * t4 - Ty_d * t4 * t40 - t4 * t19 * un3 + Tz * t4 * t5 * t19 + Tz_d * t4 * t19 * t41); -t15 * t20 * t49 * t51 * (et1 + et2 + et3 + et4 + et5); -(t15 * t21 * t51 * (et6 + et7)) / t31; -t15 * t21 * t38 * t49 * t51 * (et8 + et9 + et10 + et11 + et12)]';

epsilon = 0.005; % Numeric threshold for static dry friction
